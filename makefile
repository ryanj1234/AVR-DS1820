...
SRC = $(TARGET).c OWIcrc.c OWISWBitFunctions.c OWIHighLevelFunctions.c \
	OWISWBitFunctions.c ../uart/uart.c
...
# AVRDUDE_PORT = /dev/tty    # programmer connected to serial device
